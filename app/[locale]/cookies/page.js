        ...
        <main className="flex-1 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 py-12">
            <div className="bg-white rounded-xl border border-gray-200 p-8 space-y-8">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Política de galetes</h1>
                <p className="text-sm text-gray-500">Darrera actualització: febrer de 2026</p>
              </div>

              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-gray-900">1. Què són les galetes?</h2>
                <p className="text-gray-700 leading-relaxed">
                  Les galetes són petits fitxers de text que els llocs web emmagatzemen al vostre dispositiu
                  quan els visiteu. Serveixen perquè el lloc funcioni correctament, recordar les vostres
                  preferències i recopilar informació sobre com s'utilitza el servei.
                </p>
              </section>

              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-gray-900">2. Galetes que utilitzem</h2>

                <h3 className="text-lg font-medium text-gray-800">Galetes tècniques (necessàries)</h3>
                <p className="text-gray-700 leading-relaxed">
                  Són imprescindibles perquè el Servei funcioni. Sense elles no podríeu iniciar sessió
                  ni crear campanyes. No requereixen el vostre consentiment.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="text-left px-4 py-2 font-medium text-gray-700">Galeta</th>
                        <th className="text-left px-4 py-2 font-medium text-gray-700">Proveïdor</th>
                        <th className="text-left px-4 py-2 font-medium text-gray-700">Finalitat</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      <tr>
                        ...
                        <td className="px-4 py-2 text-gray-700">Gestió de la sessió d'usuari</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2 text-gray-700 font-mono">cf_clearance</td>
                        <td className="px-4 py-2 text-gray-700">Cloudflare</td>
                        <td className="px-4 py-2 text-gray-700">Verificació de seguretat anti-bot</td>
                      </tr>
                    </tbody>
                  </table>
                </div>

                <h3 className="text-lg font-medium text-gray-800 mt-4">Galetes analítiques</h3>
                <p className="text-gray-700 leading-relaxed">
                  Utilitzem PostHog per entendre com s'utilitza Herdfy i millorar el Servei.
                  Les dades recollides són anonimitzades i no permeten identificar-vos personalment.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                    <thead className="bg-gray-50">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      <tr>
                        ...
                        <td className="px-4 py-2 text-gray-700">Analítica d'ús anonimitzada</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-gray-900">3. Com gestionar les galetes</h2>
                <p className="text-gray-700 leading-relaxed">
                  Podeu configurar el vostre navegador per bloquejar o eliminar galetes. Tingueu en compte que
                  bloquejar les galetes tècniques pot afectar el funcionament del Servei.
                </p>
              ...
              <section className="space-y-3">
                <h2 className="text-xl font-semibold text-gray-900">4. Contacte</h2>
                <p className="text-gray-700 leading-relaxed">
                  Per a qualsevol consulta sobre l'ús de galetes podeu escriure'ns a{' '}
